// ======================================================================
// BeoM_main.v generated from TopDesign.cysch
// 09/02/2020 at 23:37
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=2, CONTROL3=0, ControlRegRemoved=1, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeviceFamily=PSoC4, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=true, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=1, IntOnTC=1, NumberOfCaptures=4, param45=1, Period=79, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=rstSts, RunMode=1, SiliconRevision=17, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=true, TriggerMode=1, UDB16=false, UDB24=false, UDB32=false, UDB8=true, UDBControlReg=false, UsesHWEnable=1, VerilogSectionReplacementString=sT8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=DATALINK_Timer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DATALINK_Timer, CY_INSTANCE_SHORT_NAME=DATALINK_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=DATALINK_Timer, )
...
module top ;
	...
	wire [1:0] tmpOE__PWR_OK_MODE_net;
	wire [1:0] tmpIO_1__PWR_OK_MODE_net;
	electrical [0:0] tmpSIOVREF__PWR_OK_MODE_net;
	...
	cy_psoc3_pins_v1_10
		...
		PWR_OK_MODE
		 (.oe(tmpOE__PWR_OK_MODE_net),
		  .y({2'b0}),
		  .fb({Net_1117, Net_1441}),
		  .io({tmpIO_1__PWR_OK_MODE_net[1:0]}),
		  .siovref(tmpSIOVREF__PWR_OK_MODE_net),
		  .interrupt({Net_1078}),
		  .annotation({Net_1093, Net_1123}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWR_OK_MODE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
	...
	wire [0:0] tmpOE__BT_SBC_net;
	wire [0:0] tmpFB_0__BT_SBC_net;
	wire [0:0] tmpIO_0__BT_SBC_net;
	wire [0:0] tmpINTERRUPT_0__BT_SBC_net;
	electrical [0:0] tmpSIOVREF__BT_SBC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("00e17b26-25c7-4743-b6d6-2df5302d92c7"),
		  ...
		  .input_buffer_sel(2'b00))
		BT_SBC
		 (.oe(tmpOE__BT_SBC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BT_SBC_net[0:0]}),
		  .io({tmpIO_0__BT_SBC_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_SBC_net),
		  .interrupt({tmpINTERRUPT_0__BT_SBC_net[0:0]}),
		  .annotation({Net_997}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BT_SBC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BT_PAIRING_net;
	wire [0:0] tmpFB_0__BT_PAIRING_net;
	wire [0:0] tmpIO_0__BT_PAIRING_net;
	wire [0:0] tmpINTERRUPT_0__BT_PAIRING_net;
	electrical [0:0] tmpSIOVREF__BT_PAIRING_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("bb99dceb-70ac-4e7f-9c46-247df4e45d67"),
		  ...
		  .input_buffer_sel(2'b00))
		BT_PAIRING
		 (.oe(tmpOE__BT_PAIRING_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BT_PAIRING_net[0:0]}),
		  .io({tmpIO_0__BT_PAIRING_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_PAIRING_net),
		  .interrupt({tmpINTERRUPT_0__BT_PAIRING_net[0:0]}),
		  .annotation({Net_995}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BT_PAIRING_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWR_RPI_net;
	wire [0:0] tmpFB_0__PWR_RPI_net;
	wire [0:0] tmpIO_0__PWR_RPI_net;
	wire [0:0] tmpINTERRUPT_0__PWR_RPI_net;
	electrical [0:0] tmpSIOVREF__PWR_RPI_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3c70f459-bbad-40f5-b6af-3840d28696e9"),
		  ...
		  .input_buffer_sel(2'b00))
		PWR_RPI
		 (.oe(tmpOE__PWR_RPI_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWR_RPI_net[0:0]}),
		  .io({tmpIO_0__PWR_RPI_net[0:0]}),
		  .siovref(tmpSIOVREF__PWR_RPI_net),
		  .interrupt({tmpINTERRUPT_0__PWR_RPI_net[0:0]}),
		  .annotation({Net_1040}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PWR_RPI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BT_APTX_net;
	wire [0:0] tmpFB_0__BT_APTX_net;
	wire [0:0] tmpIO_0__BT_APTX_net;
	wire [0:0] tmpINTERRUPT_0__BT_APTX_net;
	electrical [0:0] tmpSIOVREF__BT_APTX_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("efa7e4d4-df4e-403e-836e-73adf104d5e0"),
		  ...
		  .input_buffer_sel(2'b00))
		BT_APTX
		 (.oe(tmpOE__BT_APTX_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BT_APTX_net[0:0]}),
		  .io({tmpIO_0__BT_APTX_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_APTX_net),
		  .interrupt({tmpINTERRUPT_0__BT_APTX_net[0:0]}),
		  .annotation({Net_1001}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BT_APTX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BT_LL_net;
	wire [0:0] tmpFB_0__BT_LL_net;
	wire [0:0] tmpIO_0__BT_LL_net;
	wire [0:0] tmpINTERRUPT_0__BT_LL_net;
	electrical [0:0] tmpSIOVREF__BT_LL_net;
	...
	cy_psoc3_pins_v1_10
		...
		BT_LL
		 (.oe(tmpOE__BT_LL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BT_LL_net[0:0]}),
		  .io({tmpIO_0__BT_LL_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_LL_net),
		  .interrupt({tmpINTERRUPT_0__BT_LL_net[0:0]}),
		  .annotation({Net_1003}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BT_LL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BT_HD_net;
	wire [0:0] tmpFB_0__BT_HD_net;
	wire [0:0] tmpIO_0__BT_HD_net;
	wire [0:0] tmpINTERRUPT_0__BT_HD_net;
	electrical [0:0] tmpSIOVREF__BT_HD_net;
	...
	cy_psoc3_pins_v1_10
		...
		BT_HD
		 (.oe(tmpOE__BT_HD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BT_HD_net[0:0]}),
		  .io({tmpIO_0__BT_HD_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_HD_net),
		  .interrupt({tmpINTERRUPT_0__BT_HD_net[0:0]}),
		  .annotation({Net_1005}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BT_HD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BT_Tx_Rx_net;
	wire [0:0] tmpFB_0__BT_Tx_Rx_net;
	wire [0:0] tmpIO_0__BT_Tx_Rx_net;
	wire [0:0] tmpINTERRUPT_0__BT_Tx_Rx_net;
	electrical [0:0] tmpSIOVREF__BT_Tx_Rx_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("795c0072-a5a5-4092-865f-131d956b89c0"),
		  ...
		  .input_buffer_sel(2'b00))
		BT_Tx_Rx
		 (.oe(tmpOE__BT_Tx_Rx_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BT_Tx_Rx_net[0:0]}),
		  .io({tmpIO_0__BT_Tx_Rx_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_Tx_Rx_net),
		  .interrupt({tmpINTERRUPT_0__BT_Tx_Rx_net[0:0]}),
		  .annotation({Net_985}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BT_Tx_Rx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BT_NEXT_net;
	wire [0:0] tmpFB_0__BT_NEXT_net;
	wire [0:0] tmpIO_0__BT_NEXT_net;
	wire [0:0] tmpINTERRUPT_0__BT_NEXT_net;
	electrical [0:0] tmpSIOVREF__BT_NEXT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("135f4869-e903-4024-b0ab-50b889f9c110"),
		  ...
		  .input_buffer_sel(2'b00))
		BT_NEXT
		 (.oe(tmpOE__BT_NEXT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BT_NEXT_net[0:0]}),
		  .io({tmpIO_0__BT_NEXT_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_NEXT_net),
		  .interrupt({tmpINTERRUPT_0__BT_NEXT_net[0:0]}),
		  .annotation({Net_987}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BT_NEXT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BT_PREVIOUS_net;
	wire [0:0] tmpFB_0__BT_PREVIOUS_net;
	wire [0:0] tmpIO_0__BT_PREVIOUS_net;
	wire [0:0] tmpINTERRUPT_0__BT_PREVIOUS_net;
	electrical [0:0] tmpSIOVREF__BT_PREVIOUS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("40fef45f-8642-4b15-a055-c271c060299a"),
		  ...
		  .input_buffer_sel(2'b00))
		BT_PREVIOUS
		 (.oe(tmpOE__BT_PREVIOUS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BT_PREVIOUS_net[0:0]}),
		  .io({tmpIO_0__BT_PREVIOUS_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_PREVIOUS_net),
		  .interrupt({tmpINTERRUPT_0__BT_PREVIOUS_net[0:0]}),
		  .annotation({Net_989}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BT_PREVIOUS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BT_PAUSE_net;
	wire [0:0] tmpFB_0__BT_PAUSE_net;
	wire [0:0] tmpIO_0__BT_PAUSE_net;
	wire [0:0] tmpINTERRUPT_0__BT_PAUSE_net;
	electrical [0:0] tmpSIOVREF__BT_PAUSE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("587867bb-0c8d-454c-a89f-1b9375411f53"),
		  ...
		  .input_buffer_sel(2'b00))
		BT_PAUSE
		 (.oe(tmpOE__BT_PAUSE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BT_PAUSE_net[0:0]}),
		  .io({tmpIO_0__BT_PAUSE_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_PAUSE_net),
		  .interrupt({tmpINTERRUPT_0__BT_PAUSE_net[0:0]}),
		  .annotation({Net_991}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BT_PAUSE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BT_RE_CONNECT_net;
	wire [0:0] tmpFB_0__BT_RE_CONNECT_net;
	wire [0:0] tmpIO_0__BT_RE_CONNECT_net;
	wire [0:0] tmpINTERRUPT_0__BT_RE_CONNECT_net;
	electrical [0:0] tmpSIOVREF__BT_RE_CONNECT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c30eefbd-1dd2-47ce-837d-a44729e067cd"),
		  ...
		  .input_buffer_sel(2'b00))
		BT_RE_CONNECT
		 (.oe(tmpOE__BT_RE_CONNECT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BT_RE_CONNECT_net[0:0]}),
		  .io({tmpIO_0__BT_RE_CONNECT_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_RE_CONNECT_net),
		  .interrupt({tmpINTERRUPT_0__BT_RE_CONNECT_net[0:0]}),
		  .annotation({Net_993}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BT_RE_CONNECT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWR_BT_net;
	wire [0:0] tmpFB_0__PWR_BT_net;
	wire [0:0] tmpIO_0__PWR_BT_net;
	wire [0:0] tmpINTERRUPT_0__PWR_BT_net;
	electrical [0:0] tmpSIOVREF__PWR_BT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("65c37aa2-bf35-42b8-8d2c-0a48140e02aa"),
		  ...
		  .input_buffer_sel(2'b00))
		PWR_BT
		 (.oe(tmpOE__PWR_BT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWR_BT_net[0:0]}),
		  .io({tmpIO_0__PWR_BT_net[0:0]}),
		  .siovref(tmpSIOVREF__PWR_BT_net),
		  .interrupt({tmpINTERRUPT_0__PWR_BT_net[0:0]}),
		  .annotation({Net_1039}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PWR_BT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWR_SDSP_net;
	wire [0:0] tmpFB_0__PWR_SDSP_net;
	wire [0:0] tmpIO_0__PWR_SDSP_net;
	wire [0:0] tmpINTERRUPT_0__PWR_SDSP_net;
	electrical [0:0] tmpSIOVREF__PWR_SDSP_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0f605da0-8453-4ada-925a-68a8457ad859"),
		  ...
		  .input_buffer_sel(2'b00))
		PWR_SDSP
		 (.oe(tmpOE__PWR_SDSP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWR_SDSP_net[0:0]}),
		  .io({tmpIO_0__PWR_SDSP_net[0:0]}),
		  .siovref(tmpSIOVREF__PWR_SDSP_net),
		  .interrupt({tmpINTERRUPT_0__PWR_SDSP_net[0:0]}),
		  .annotation({Net_1048}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PWR_SDSP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWR_DISP_net;
	wire [0:0] tmpFB_0__PWR_DISP_net;
	wire [0:0] tmpIO_0__PWR_DISP_net;
	wire [0:0] tmpINTERRUPT_0__PWR_DISP_net;
	electrical [0:0] tmpSIOVREF__PWR_DISP_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9366021d-dc13-4d12-a7ee-184118193347"),
		  ...
		  .input_buffer_sel(2'b00))
		PWR_DISP
		 (.oe(tmpOE__PWR_DISP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWR_DISP_net[0:0]}),
		  .io({tmpIO_0__PWR_DISP_net[0:0]}),
		  .siovref(tmpSIOVREF__PWR_DISP_net),
		  .interrupt({tmpINTERRUPT_0__PWR_DISP_net[0:0]}),
		  .annotation({Net_1047}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PWR_DISP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__DATALINK_net;
	wire [0:0] tmpFB_0__DATALINK_net;
	wire [0:0] tmpINTERRUPT_0__DATALINK_net;
	electrical [0:0] tmpSIOVREF__DATALINK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		DATALINK
		 (.oe(tmpOE__DATALINK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DATALINK_net[0:0]}),
		  .io({Net_1558}),
		  .siovref(tmpSIOVREF__DATALINK_net),
		  .interrupt({tmpINTERRUPT_0__DATALINK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DATALINK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("c25be2f4-b6c2-487b-83c0-92c26eb95d99"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("195312500000"),
		  .is_direct(0),
    ...
    Timer_v2_80_4 DATALINK_Timer (
        .reset(Net_1607),
        .interrupt(Net_1578),
        .enable(Net_1560),
        .trigger(Net_1558),
        .capture(Net_1558),
        .capture_out(Net_1603),
        .tc(Net_1543),
        .clock(Net_1612));
    defparam DATALINK_Timer.CaptureCount = 2;
    defparam DATALINK_Timer.CaptureCounterEnabled = 0;
    defparam DATALINK_Timer.DeviceFamily = "PSoC4";
    defparam DATALINK_Timer.InterruptOnCapture = 0;
    defparam DATALINK_Timer.InterruptOnTC = 1;
    defparam DATALINK_Timer.Resolution = 8;
    defparam DATALINK_Timer.SiliconRevision = "17";
    ...
    assign Net_1560 = 1'h1;

    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_1612)
    begin
        cydff_1 <= Net_1611;
    end
    assign Net_1607 = cydff_1;
    // -- DFF End --


    assign Net_1611 = Net_1543 | Net_1615;
    ...
    assign Net_1615 = cydff_2;
    // -- DFF End --

	wire [0:0] tmpOE__SDSP_CS_net;
	wire [0:0] tmpFB_0__SDSP_CS_net;
	wire [0:0] tmpIO_0__SDSP_CS_net;
	wire [0:0] tmpINTERRUPT_0__SDSP_CS_net;
	electrical [0:0] tmpSIOVREF__SDSP_CS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b09b36b4-3f24-49c6-bf2a-b08607a4267d"),
		  ...
		  .input_buffer_sel(2'b00))
		SDSP_CS
		 (.oe(tmpOE__SDSP_CS_net),
		  .y({Net_1664}),
		  .fb({tmpFB_0__SDSP_CS_net[0:0]}),
		  .io({tmpIO_0__SDSP_CS_net[0:0]}),
		  .siovref(tmpSIOVREF__SDSP_CS_net),
		  .interrupt({tmpINTERRUPT_0__SDSP_CS_net[0:0]}),
		  .annotation({Net_1661}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__SDSP_CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_5 DISPLAY_Timer (
        .reset(Net_1638),
        .interrupt(Net_1644),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1633),
        .tc(Net_1658),
        .clock(Net_1656));
    defparam DISPLAY_Timer.CaptureCount = 2;
    defparam DISPLAY_Timer.CaptureCounterEnabled = 0;
    defparam DISPLAY_Timer.DeviceFamily = "PSoC4";
    defparam DISPLAY_Timer.InterruptOnCapture = 0;
    defparam DISPLAY_Timer.InterruptOnTC = 1;
    defparam DISPLAY_Timer.Resolution = 16;
    defparam DISPLAY_Timer.SiliconRevision = "17";

    // -- DFF Start --
    reg  cydff_3;
    always @(posedge Net_1656)
    begin
        cydff_3 <= Net_1658;
    end
    assign Net_1638 = cydff_3;
    // -- DFF End --

	wire [0:0] tmpOE__DISP_CS_net;
	wire [0:0] tmpFB_0__DISP_CS_net;
	wire [0:0] tmpIO_0__DISP_CS_net;
	wire [0:0] tmpINTERRUPT_0__DISP_CS_net;
	...
	assign tmpOE__DISP_CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PSoC_LED_net;
	wire [0:0] tmpFB_0__PSoC_LED_net;
	wire [0:0] tmpIO_0__PSoC_LED_net;
	wire [0:0] tmpINTERRUPT_0__PSoC_LED_net;
	electrical [0:0] tmpSIOVREF__PSoC_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4cb45839-cb02-4a5d-88c9-1d5b06513902"),
		  ...
		  .input_buffer_sel(2'b00))
		PSoC_LED
		 (.oe(tmpOE__PSoC_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PSoC_LED_net[0:0]}),
		  .io({tmpIO_0__PSoC_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__PSoC_LED_net),
		  .interrupt({tmpINTERRUPT_0__PSoC_LED_net[0:0]}),
		  .annotation({Net_1694}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PSoC_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
