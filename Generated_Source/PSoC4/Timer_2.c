...
void Timer_2_Enable(void)
{
    ...
    #if (Timer_2__QUAD == Timer_2_CONFIG)
        #if (0u != Timer_2_QUAD_AUTO_START)
            Timer_2_TriggerCommand(Timer_2_MASK, Timer_2_CMD_RELOAD);
        #endif /* (0u != Timer_2_QUAD_AUTO_START) */
    #endif  /* (Timer_2__QUAD == Timer_2_CONFIG) */
}
...
*   Values:
*     - Timer_2_CMD_CAPTURE    - Trigger Capture/Switch command
*     - Timer_2_CMD_RELOAD     - Trigger Reload/Index command
*     - Timer_2_CMD_STOP       - Trigger Stop/Kill command
*     - Timer_2_CMD_START      - Trigger Start/phiB command
*
* Return:
*  None
*
