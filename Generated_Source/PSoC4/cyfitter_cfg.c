...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT13), 0x00000030u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C00), 0x8000124Fu);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG4), 0x88000000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG4), 0xA0000000u);

		/* UDB_P0_U0_CFG24 Starting address: CYDEV_UDB_P0_U0_CFG24 */
		CY_SET_REG32((void *)(CYREG_UDB_P0_U0_CFG24), 0x84040404u);

		/* TCPWM_CNT0 Starting address: CYDEV_TCPWM_CNT0_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT0_TR_CTRL0), 0x0006A710u);

		/* TCPWM_CNT1 Starting address: CYDEV_TCPWM_CNT1_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT1_TR_CTRL0), 0x0009B310u);
	...
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x0058E249u);

	/* IOPINS0_1 Starting address: CYDEV_PRT1_BASE */
	CY_SET_REG32((void *)(CYREG_PRT1_PC), 0x001803B6u);
	...
	CY_SET_REG32((void *)(CYDEV_PRT3_BASE), 0x000000C2u);
	CY_SET_REG32((void *)(CYREG_PRT3_PC), 0x004B0271u);
	CY_SET_REG32((void *)(CYREG_PRT3_INTCFG), 0x00005000u);
