...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        MOSI_1_PC =   (MOSI_1_PC & \
                                (uint32)(~(uint32)(MOSI_1_DRIVE_MODE_IND_MASK << (MOSI_1_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (MOSI_1_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(MOSI_1__0__SHIFT, mode);
}
