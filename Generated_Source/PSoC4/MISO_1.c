...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        MISO_1_PC =   (MISO_1_PC & \
                                (uint32)(~(uint32)(MISO_1_DRIVE_MODE_IND_MASK << (MISO_1_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (MISO_1_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(MISO_1__0__SHIFT, mode);
}
